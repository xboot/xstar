#ifndef __XSTAR_DRIVER_BATTERY_H__
#define __XSTAR_DRIVER_BATTERY_H__
...
struct battery_t {
	...
	int (*update)(struct battery_t * bat, struct battery_info_t * info);
	void * priv;
};
...
#endif /* __XSTAR_DRIVER_BATTERY_H__ */
