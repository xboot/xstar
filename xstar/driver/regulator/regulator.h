#ifndef __XSTAR_DRIVER_REGULATOR_H__
#define __XSTAR_DRIVER_REGULATOR_H__
...
struct regulator_t {
	...
	void (*set_enable)(struct regulator_t * supply, int enable);
	int (*get_enable)(struct regulator_t * supply);
...
#endif /* __XSTAR_DRIVER_REGULATOR_H__ */
