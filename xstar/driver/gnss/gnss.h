#ifndef __XSTAR_DRIVER_GNSS_H__
#define __XSTAR_DRIVER_GNSS_H__
...
static inline struct gnss_nmea_t * gnss_get_nmea(struct gnss_t * nav)
{
	return nav ? &nav->nmea : NULL;
}
