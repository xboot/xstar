...
enum device_type_t {
	DEVICE_TYPE_ADC				= 0,
	DEVICE_TYPE_ATNET			= 1,
	DEVICE_TYPE_AUDIOCAPTURE	= 2,
	DEVICE_TYPE_AUDIOPLAYBACK	= 3,
	DEVICE_TYPE_BATTERY			= 4,
	DEVICE_TYPE_BLOCK			= 5,
	DEVICE_TYPE_BUZZER			= 6,
	DEVICE_TYPE_CAMERA			= 7,
	DEVICE_TYPE_CLK				= 8,
	DEVICE_TYPE_CLOCKEVENT		= 9,
	DEVICE_TYPE_CLOCKSOURCE		= 10,
	DEVICE_TYPE_COMPASS			= 11,
	DEVICE_TYPE_CONSOLE			= 12,
	DEVICE_TYPE_DAC				= 13,
	DEVICE_TYPE_DMACHIP			= 14,
	DEVICE_TYPE_FRAMEBUFFER		= 15,
	DEVICE_TYPE_G2D				= 16,
	DEVICE_TYPE_GMETER			= 17,
	DEVICE_TYPE_GNSS			= 18,
	DEVICE_TYPE_GPIOCHIP		= 19,
	DEVICE_TYPE_GYROSCOPE		= 20,
	DEVICE_TYPE_HWSPINLOCK		= 21,
	...
	DEVICE_TYPE_SPI				= 45,
	DEVICE_TYPE_STEPPER			= 46,
	DEVICE_TYPE_THERMOMETER		= 47,
	DEVICE_TYPE_UART			= 48,
	DEVICE_TYPE_VIBRATOR		= 49,
	DEVICE_TYPE_WATCHDOG		= 50,

	DEVICE_TYPE_MAX_COUNT		= 51,
};
