...
LDFLAGS		+= -march=rv64imafdcv_zifencei_zicbom_zicbop_zicboz_zicond_zihintntl_zihintpause_zawrs_zfa_zfbfmin_zfh_zba_zbb_zbc_zbs_zvfbfmin_zvfbfwma_svinval_svnapot_svpbmt_xtheadc_xtheadvdot -mabi=lp64d
OCFLAGS		+=
ODFLAGS		+=
MCFLAGS		+= -march=rv64imafdcv_zifencei_zicbom_zicbop_zicboz_zicond_zihintntl_zihintpause_zawrs_zfa_zfbfmin_zfh_zba_zbb_zbc_zbs_zvfbfmin_zvfbfwma_svinval_svnapot_svpbmt_xtheadc_xtheadvdot -mabi=lp64d -mtune=c907 -mcmodel=medany -fno-stack-protector -mstrict-align
LIBDIRS		+=
LIBS 		+= -lgcc
